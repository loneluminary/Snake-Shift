...
namespace Utilities.Extensions
{
	...
	{
		public static float RandomBias(this float value, float range, bool useNegativeBias = true) => value + value * UnityEngine.Random.Range(useNegativeBias ? -range : 0, range);
