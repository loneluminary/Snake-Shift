...
namespace Utilities.Extensions
{
    ...
    {
        public static Vector3Int SetValue(this Vector3Int v, int value) => new(value, value, value);
        ...
        public static Vector3Int WithAddX(this Vector3Int v, int x) => new(v.x + x, v.y, v.z);

        public static Vector3Int WithSubtractX(this Vector3Int v, int x) => new(v.x - x, v.y, v.z);

        public static Vector3Int WithMultiplyX(this Vector3Int v, int x) => new(v.x * x, v.y, v.z);
        ...
        public static Vector3Int WithAddY(this Vector3Int v, int y) => new(v.x, v.y + y, v.z);

        public static Vector3Int WithSubtractY(this Vector3Int v, int y) => new(v.x, v.y - y, v.z);

        public static Vector3Int WithMultiplyY(this Vector3Int v, int y) => new(v.x, v.y * y, v.z);
        ...
        public static Vector3Int WithAddZ(this Vector3Int v, int z) => new(v.x, v.y, v.z + z);

        public static Vector3Int WithSubtractZ(this Vector3Int v, int z) => new(v.x, v.y, v.z - z);

        public static Vector3Int WithMultiplyZ(this Vector3Int v, int z) => new(v.x, v.y, v.z * z);
        ...
        public static Vector3Int Max(this Vector3Int a, Vector3Int b) => new(Mathf.Max(a.x, b.x), Mathf.Max(a.y, b.y), Mathf.Max(a.z, b.z));

        public static Vector3Int Min(this Vector3Int a, Vector3Int b) => new(Mathf.Min(a.x, b.x), Mathf.Min(a.y, b.y), Mathf.Min(a.z, b.z));
        ...
        public static Vector2 ToVector2XY(this Vector3Int v) => new(v.x, v.y);

        public static Vector2 ToVector2XZ(this Vector3Int v) => new(v.x, v.z);

        public static Vector2 ToVector2YZ(this Vector3Int v) => new(v.y, v.z);
        ...
        public static Vector3Int ScaleBy(this Vector3Int v, Vector3Int scale) => new(v.x * scale.x, v.y * scale.y, v.z * scale.z);
