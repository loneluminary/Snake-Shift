...
namespace Utilities.Extensions
{
	...
	{
		public static void SetAnchor(this RectTransform source, AnchorPresets align, bool applyPosition = false, bool applyStrech = false, int offsetX = 0, int offsetY = 0)
		{
			if (applyPosition) source.anchoredPosition = new Vector3(offsetX, offsetY, 0);
