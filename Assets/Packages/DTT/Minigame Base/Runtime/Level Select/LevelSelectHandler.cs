...
namespace DTT.MinigameBase.LevelSelect
{
    ...
    public abstract class LevelSelectHandler<TConfig, TResult, TMinigame> : LevelSelectHandlerBase where TMinigame : Object, IMinigame<TConfig, TResult>
    {
        ...
        /// Adds listeners.
        /// </summary>
        private void OnEnable() => _minigame.Finish += OnMinigameFinished;

        /// <summary>
        /// Removes listeners.
        /// </summary>
        private void OnDisable() => _minigame.Finish -= OnMinigameFinished;
        ...
        protected virtual void OnMinigameFinished(TResult result)
        {
            ...
            _levelDatabase.SetScore(_levelSelect.SelectedLevel.LevelNumber - 1, score);
