...
namespace UI.Pagination
{
    ...
    {
        private Dictionary<PaginationButton.eButtonType, List<PaginationButton>> buttonPool = new();
        ...
        public void UpdatePagination()
        {
            ...
            if (Button_PreviousPage != null) Button_PreviousPage.interactable = CurrentPage != 1 || LoopEndlessly;
            if (Button_NextPage != null) Button_NextPage.interactable = CurrentPage != NumberOfPages || LoopEndlessly;
        }
        ...
        {
            if (Button_NextPage) Button_NextPage.gameObject.SetActive(show);
            if (Button_PreviousPage) Button_PreviousPage.gameObject.SetActive(show);
            ...
            if (show)
            {
                ...
                {
                    Button_PreviousPage.onClick.RemoveAllListeners();
                    Button_PreviousPage.onClick.AddListener(PreviousPage);
                }
            }
        }
