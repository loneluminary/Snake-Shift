...
namespace UI.Pagination
{
    class PassThroughDragEvents : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        Dictionary<string, Dictionary<MonoBehaviour, MethodInfo>> m_Events = new();

        static List<string> eventTypes = new()
        {
            "OnBeginDrag",
            "OnEndDrag",
            "OnDrag"
        ...
        Vector2 m_dragStartPosition = new();
        Vector2 m_dragEndPosition = new();
        Vector2 m_delta = new();
